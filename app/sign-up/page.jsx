  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-400 via-green-500 to-green-600">
      <div className="bg-white p-10 rounded-lg shadow-xl w-96">
        <h1 className="text-gray-900 text-2xl mb-5 font-bold text-center">Join NutriTrack</h1>
        <input 
          type="email" 
          placeholder="Email" 
          value={email} 
        ...
        >
         ...
         <h1 className="text-gray-900 text-sm mt-5 font-bold text-center">Already have an account <Link href="/sign-in" className='text-blue-500 underline '>Sign In</Link> instead</h1>
      </div>
    </div>
  );
};
